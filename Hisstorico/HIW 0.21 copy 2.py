...
def ventanaEmergenteDef(resultado, pantalla):
        ...
        for i, nDatos in enumerate(resultado):
            textoEmergente = font.render("Ficha Atacante: " + str(round(nDatos[0])), True, NEGRO) # fichaAtacante.ataque
            textoEmergente2 = font.render("Ficha Defensora: " + str(round(nDatos[1])), True, NEGRO) # fichaDefensora
...
while True:
    ...
    for i, text_surface in enumerate(text_surfaces): # fichas
        ...
        ventana.blit(text_surface, (ANCHO - 300, ALTO - 575 + i * line_height)) #730,550

    line_height = 25
    for i, text_surface in enumerate(text_surfaces2): # provincias
        # Dibujar cada línea en la pantalla
        ventana.blit(text_surface, (ANCHO - 300, ALTO - 400 + i * line_height)) #730,550
    ...
    rect_imagen = imagen.get_rect() # FICHA
    rect_imagen.topleft = (ANCHO - 600, ALTO - 575) #650,300
    ...
    rect_imagenprov.topleft = (ANCHO - 600,ALTO - 400) #550,550
