...
def ventanaEmergenteDef(fichaAtacante, fichaDefensora, pantalla):
        ventana_emergente = pygame.Surface((400, 200))
        ventana_emergente.fill(BLANCO)
        rect_ventana_emergente = ventana_emergente.get_rect(center=(800,150)) #center=(400 // 2, 200 // 2)
 
        # Dibujar la ventana emergente en la pantalla principal
        ventana.blit(ventana_emergente, rect_ventana_emergente)
        textoEmergente = font.render("Ficha Atacante: " + str(fichaAtacante.ataque), True, NEGRO)
        textoEmergente2 = font.render("Ficha Defensora: " + str(fichaDefensora.defensa), True, NEGRO)
        pantalla.blit(textoEmergente, (rect_ventana_emergente.x + 30, rect_ventana_emergente.y + 30))
        pantalla.blit(textoEmergente2, (rect_ventana_emergente.x + 30, rect_ventana_emergente.y + 60))
        pygame.draw.rect(ventana, NEGRO, pygame.Rect(rect_ventana_emergente.x, rect_ventana_emergente.y, 400, 200), width=1, border_radius=5)
...
while True:
    ...
    for i, text_surface in enumerate(text_surfaces): # fichas
        ...
        ventana.blit(text_surface, (830, 300 + i * line_height)) #730,550

    line_height = 25
    for i, text_surface in enumerate(text_surfaces2): # provincias
        # Dibujar cada línea en la pantalla
        ventana.blit(text_surface, (730, 550 + i * line_height)) #830,350
    ...
    rect_imagen.topleft = (650, 300) #550,550
    ...
    rect_imagenprov.topleft = (550,550) #650,300
    ...
    if ventanaEmergente == True:
        ventanaEmergenteDef(fichaSeleccionada, ficha, ventana)
