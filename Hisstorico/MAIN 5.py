...
ficha1 = Ficha("img/caballeria2.png",250 ,200, "Cristiano",20, 8, 45)
        ...
        if event.type == pygame.QUIT:
            ...
            for ficha in mis_sprites_fichas:
                ...
                if ficha.rect.collidepoint(event.pos): # Selecciono o deselecciono si el evento del ratón colisiona
                   ...
                   DatosFicha1 = f'{ficha.bando}'
                   DatosFicha2 = f'{ficha.ataque}'
                   DatosFicha3 = f'{ficha.defensa}'
                   DatosFicha4 = f'{ficha.salud}'
