...
def movimientoVector(ficha,vectorAtacante, vectorDestino):
    vectorAtacante.move_towards_ip(vectorDestino,1)
    ventana.blit(ficha.image,vectorDestino)
    print("He entrado")
...
while True:
    ...
    #ventana.blit(fichaSeleccionada.image, vectorFicha) 
    ...
    if mover:
        vectorFicha.move_towards_ip(vectorProvincia,6)
        if vectorFicha == vectorProvincia:
            mover = False
    ventana.blit(fichaSeleccionada.image,vectorFicha)
